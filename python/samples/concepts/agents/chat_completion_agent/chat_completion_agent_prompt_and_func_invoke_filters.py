...
from semantic_kernel.filters.agent_contexts import FunctionInvocationContext, PromptRenderContext
...
a function invocation filter is used to handle user input and output.
"""
