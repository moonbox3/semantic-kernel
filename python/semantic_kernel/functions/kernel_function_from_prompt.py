...
class KernelFunctionFromPrompt(KernelFunction):
    ...
    def __init__(self, name: str, description: str, prompt_template_config: PromptTemplateConfig, execution_settings: AIRequestSettings):
    ...
    def create(prompt_template: PromptTemplate, prompt_template_config: PromptTemplateConfig, execution_settings) -> KernelFunction:
