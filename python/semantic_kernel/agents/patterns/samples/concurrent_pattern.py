...
async def main():
    ...
    concurrent_pattern = await ConcurrentPattern.create([physics_agent, chemistry_agent])
    await concurrent_pattern.start(task="Why is the sky blue in one sentence?")
